    ...
    <Box bg="gray.100" minH="100vh">
      ...
      <Container maxW="container.lg" py={8}>
        ...
        <VStack align="start" spacing={8}>
          ...
          <Text fontSize="lg">Supports various causes such as veterans, space program, same-sex marriage, and the environment. Serves as campaign chair of the Hidden Heroes Campaign of the Elizabeth Dole Foundation.</Text>
        </VStack>
      </Container>
    </Box>
  );
